...
const primaryGenree = genres[1];
const secondaryGenree = genres[2];
console.log(primaryGenree, secondaryGenree)

//Automatically assign first value of generes to primaryGenere and second value to SecondaryGenre
const [primaryGenre, secondaryGenre] = genres;
console.log(primaryGenre, secondaryGenre)


// Rest Opreator (...)
const [primaryGenre3, secondaryGenre3, ...OtherGenere] = genres;
console.log(primaryGenre, secondaryGenre, OtherGenere)
...
//updating the object literals (Used in React State)
const updatedBooks = {
    ...book,
